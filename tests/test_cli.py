...
def sample_text_file():
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.txt', delete=False, encoding='utf-8') as f:
        f.write("De kat zit op de mat. De hond rent in de tuin. Dit is een test voor de CLI.")
        return Path(f.name)
...
class TestCLICommands:
    ...
    def test_score_command_with_text(self, runner):
        ...
        result = runner.invoke(app, ["score", "--text", "De kat zit op de mat. De hond rent."])
        assert result.exit_code == 0
    ...
    def test_score_command_detailed(self, runner):
        ...
        result = runner.invoke(app, ["score", "--text", "Eerste zin. Tweede zin.", "--detailed"])
        assert result.exit_code == 0
    ...
    def test_score_command_json_output(self, runner):
        ...
        result = runner.invoke(app, ["score", "--text", "Test zin.", "--format", "json"])
        assert result.exit_code == 0
...
class TestCLIOutputFormats:
    ...
    def test_json_output_format(self, runner):
        ...
        result = runner.invoke(app, [
            "score", "--text", "Eerste zin. Tweede zin.", 
        ...
        try:
            data = json.loads(result.stdout)
            required_fields = ["document_score", "document_level", "document_level_description"]
    ...
    def test_csv_output_format(self, runner):
        ...
        result = runner.invoke(app, [
            "score", "--text", "Test zin.", "--format", "csv"
        ])
        assert result.exit_code == 0
...
class TestCLIErrorHandling:
    ...
    def test_invalid_format_option(self, runner):
        ...
        result = runner.invoke(app, [
            "score", "--text", "Test zin.", "--format", "invalid"
        ])
