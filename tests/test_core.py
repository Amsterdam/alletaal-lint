...
import pytest
from alletaal_lint.core import Document, Sentence, LintScorer, WordStats
...
class TestSentence:
    ...
    def complex_sentence(self):
        ...
        return Sentence("De ingewikkelde bureaucratische procedures worden doorlopend geëvalueerd door de verantwoordelijke ambtenaren.")
...
class TestDocument:
    ...
    def simple_document(self):
        ...
        return Document("De kat zit op de mat. De hond rent in de tuin. Dit is een test.")
    ...
    def test_detailed_analysis(self, simple_document):
        ...
        required_keys = [
            ...
            'sentence_scores', 'average_sentence_length'
        ]
